...
short RAMSES_code1[6] = {8,3,4,1,7,6,};//RAMSES01
short RAMSES_time1[6] = {50,50,50,50,50,50};   

short RAMSES_code[6] = {1,2,5,4,6,3}; //RAMSES07
short RAMSES_freq[6] = {20830,22500,24170,25830,27500,29170};     
short RAMSES_time[6] = {600,600,600,600,600,600}; 

#pragma DATA_SECTION(Send_sig,"send")
short Send_sig[7200];//·¢ÉäĞÅºÅ
