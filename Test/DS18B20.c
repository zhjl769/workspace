...
#define DATA_OUT P9DIR |= BIT3// DS18B20数据脚为输出,
#define DATA_IN  P9DIR &= ~BIT3// DS18B20数据脚为输入,
#define DATA_H   P9OUT |= BIT3//DS18B20数据脚输出高电平,
#define DATA_L   P9OUT &= ~BIT3//DS18B20数据脚输出低电平,
#define DATA_IO  (P9IN & BIT3)//DS18B20数据脚,
#define DATA_ST  BIT3//DS18B20数据脚,
